    ...
    if TRAIN == "True":
        ...
        if len(canon_pairs) > 0:
           ...
           class GenCallback(tf.keras.callbacks.Callback):
              ...
              def on_epoch_end(self, epoch, logs={}):
                 if epoch in epochs_to_save:
                    smi2smi.save_weights(f"{path}/tr-" + str(epoch) + ".h5", save_format="h5")
           ...
           if CHIRALITY == "True":
              ...
              shutil.copy("pretrained/embeddings-nochiral.npy", f"{path}/embeddings.npy")
